    ...
    for (key in attributes) {
      ...
      if (attribute.references) {
        ...
        if (existingConstraints.includes(attribute.references.model.toString())) {
          console.warn("***** existingConstraints", existingConstraints)
          ...
          console.warn("***** existingConstraints update", existingConstraints)
          throw new Error(JSON.stringify(existingConstraints))
